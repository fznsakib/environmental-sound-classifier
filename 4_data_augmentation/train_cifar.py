...
parser.add_argument("--data-aug-distortion", default=0, type=float)
...
def main(args):
    ...
    if (args.data_aug_brightness > 0):
        transform_list.append(torchvision.transforms.ColorJitter(brightness=args.data_aug_brightness))
    if (args.data_aug_distortion > 0):
        transform_list.append(torchvision.transforms.RandomPerspective(distortion_scale=args.data_aug_distortion))
...
def get_summary_writer_log_dir(args: argparse.Namespace) -> str:
    ...
    tb_log_dir_prefix = (
      ...
      f"distortion={args.data_aug_distortion}_" +
